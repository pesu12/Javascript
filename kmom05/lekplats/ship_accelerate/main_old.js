...
/**
 * A Bullet as an object.
 */
function Bullet(width, height, position, velocity, direction) {
...
Bullet.prototype.draw = function(ct) {
...
Bullet.prototype.update = function() {
  ...
  if (Key.isDown(Key.SPACE))     this.bulletactive=true;
};

Bullet.prototype.stayInArea = function(width, height) {
  if(this.position.x > width)         {this.bulletactive=false;this.position.x= width/2;this.position.y=height/2};
};
...
window.Asteroids = (function(){
  ...
  var init = function(canvas) {
    ...
    bullet = new Bullet(10, 20, new Vector(width/2, height/2), new Vector(2, 2), 0);
  ...
  var update = function() {
    ...
    bullet.update();
    bullet.stayInArea(width, height);
  };
